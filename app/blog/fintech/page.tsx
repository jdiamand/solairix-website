...
export default function BlogCategoryAI() {
    const aiMlArticles24 = [
        {
            title: "Fintech Phases Part 1: From Transatlantic Cables to the iPhone",
            link: "https://lnkd.in/eWku9dHj",
            image: "/blog-thumbnails/fintech-phase-part-1.png",
        },
        {
            title: "Unmasking Anonymity in Bitcoin Transactions",
            link: "https://lnkd.in/eYk3Nvn2",
            image: "/blog-thumbnails/unmaskbitcoin.png",
        },
    ];
    // const aiMlArticles25 = [
    //     {
    //         title: "Fintech Phases Part 2: ...",
    //         link: "https://lnkd.in/...",
    //         image: "/blog-thumbnails/fintech-phase-part-2.png",
    //     },
    // ];
    ...
    return (
        <div className="flex flex-col items-center min-h-screen text-center p-8">
            ...
            {/* 🔹 Fintech Articles Subtitle */}
            <p className="text-2xl font-bold mt-4 text-yellow-400">Fintech Articles</p>
